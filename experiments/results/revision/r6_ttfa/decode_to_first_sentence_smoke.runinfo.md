...
- 命令: `/dataA/streamllm/experiments/scripts/measure_decode_to_first_sentence.py --llm-device cuda:1 --max-samples 3 --output experiments/results/revision/r6_ttfa/decode_to_first_sentence_smoke.csv`
- git commit: dd2e6e03c4613e835ef632956b76a5b8f97d6523
- 起止: 2026-08-21T10:58:33 → 2026-08-21T10:59:04（耗时 31s）
...
- 样本: 3 条（streaming 模式），sample_ids sha256: b73ed71a9565f5af73f8ff8cc2589c1db60ba38bb0644af87076d7c49ead4c79
...
- 结果: rows=3, error=0；CSV=decode_to_first_sentence_smoke.csv；summary=decode_to_first_sentence_smoke.summary.txt
