...
run `sci34_dc52978_20260901_async_prepared_v2`（代码 `dc52978`、结果 `ee1dcc7`）满足全部验收门槛：180 条正式记录、每单元 20 条、120 条片段内/60 条边界、180/180 精确软件采样目标且零泄漏；入库分析与 raw records 独立复算一致。九单元的 stop ack、post-stop sync、lookup、stop→crop、stop→role 中位数范围分别为 0.055–0.062、0.167–0.176、0.47–0.50、2.44–2.53、78.6–80.8 ms，最大单元 P95 分别约为 0.077、0.352、0.94、3.492、86.1 ms。setup 在播放前完成并排除。允许的主张与限制见 D-015、`paper2/p1_v2_acceptance_2026-09-01.md` 和 `CLAIMS_MATRIX.md`。
