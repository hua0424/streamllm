...
This file provides guidance to agents (Claude Code, ZCode, etc.) when working with code in this repository. Content mirrored from CLAUDE.md — keep the two in sync.
