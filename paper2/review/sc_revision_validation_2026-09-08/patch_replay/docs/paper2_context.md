...
| 日期 | 里程碑 | 产出 |
|---|---|---|
| 2026-09-08 | **R/B 正式接受与 SC 单主线改稿完成（D-029）** | formal `rb_formal_20260908T023934Z_f69e6478`：320 records/160 event pairs，4 sessions，B 100 trajectories/1118 cursors/27 closures；完整 tar 前轮已核验。SC 以 joint prefix-state repair 为唯一方法，新增 R 全 cell 成本表，C1/C-E1/C-E2/A2 实际移入独立编译 supplement，保留 C2 failures 与 inconclusive E3。无新实验、无 GPU 待办；源码 ZIP/主稿及补充 PDF 重建，全部 PNG 交主 orchestrator 单一视觉 gate，作者声明及权利仍待确认。详见 dated revision record；不改中文权威章节。 |
