...
\changes The general cache distinction is described in Section~III-B2 (pp.~3--4), the commitment and seam contract in Section~IV-B4 (p.~7), and incremental cache behavior in Section~IV-C (pp.~7--8). The correction, seam, and exploratory response measurements appear in Section~V-F (p.~12), and their evidentiary limits are reiterated in Sections~VI-A--C (pp.~12--13).
